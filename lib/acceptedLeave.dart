                ...
                itemBuilder: (BuildContext context, int index) {
                  return Card(
                    child: Column(
                      ...
                      children: [
                        Text("NAME:${state.acceptedLeaveModel.data![index].userid!.name}"),
                        SizedBox(
                          height: 20,
                        ),
                        Text("Day Type:${state.acceptedLeaveModel.data![index].dayType!}"),
                        Text("Leave Type:${state.acceptedLeaveModel.data![index].leaveType!}"),
                        Text("From:${state.acceptedLeaveModel.data![index].leaveFrom!}"),
                        Text("To:${state.acceptedLeaveModel.data![index].leaveTo!}"),
                        Text("REASON:${state.acceptedLeaveModel.data![index].leaveDesc!}"),
                        Text("STATUS:${state.acceptedLeaveModel.data![index].leaveStatus!}"),
